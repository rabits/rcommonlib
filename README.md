rCommonLib - some libs
======================

_All your issues can be discussed in [Issues Page](https://github.com/rabits/rcommonlib/issues)_

## About

*rCommonLib* - Some libs useful in my projects
 ...
 * [GitHub/rCommonLib](https://github.com/rabits/rcommonlib)
 * [Rabit.sru](http://rabits.ru)

## License: GNU GPLv3

    rCommonLib is free software: you can redistribute it and/or modify
